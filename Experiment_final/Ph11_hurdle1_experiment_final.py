...
def numTripsinHour(t):
    ...
    if t >= 23 and t < 24:
        return 4540
    if t>=24 and t < 25:
        return 100 # This is done purely for testing purposes (running this program over t=0 to t=24 is computationally heavy)
    else:
...
def visualizeCity(station_list,t):
    ...
    image_name = 'Paristopia_final_Experiment_t='+str(t)+'.png'
